        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-xl items-center">
          ...
          <div className="hidden lg:flex flex-col items-center justify-center p-xl animate-fadeIn bg-neutral-800 rounded-2xl" style={{ backgroundColor: 'var(--color-neutral-800)' }}>
            {/* 
              ...
              Pinterest: https://www.pinterest.com/search/pins/?q=fitness%20start%20journey%20inspiration
              Keywords: "new beginning fitness", "workout start", "health journey begins"
            */}
            <img
              src="https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=500&h=500&fit=crop"
              alt="Start your fitness journey today"
            ...
            <div className="mt-lg text-center">
              ...
              <p className="text-neutral-300 mt-sm" style={{ fontSize: 'var(--font-size-lg)' }}>
                Personalized plans, expert guidance, amazing results
              </p>
            </div>
          </div>
